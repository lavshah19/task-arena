...
const ChallengeArena = () => {
  ...
  const fetchChallenges = async () => {
    try {
      const res = await axios.get(`${baseUrl}/challenge/myparticipant`, {
  ...
  if (challenges.length === 0) return (
    <div className="flex items-center justify-center h-64 text-gray-500">
      ...
      <span>you haven't joined or create any challenge  </span>
    </div>
  );
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 md:py-12">
      <div className="flex items-center justify-center mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-blue-700"> My Challenges </h1>
      </div>
