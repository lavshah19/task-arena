...
const ChallengeArena = () => {
  const { token, user,activeTab, setActiveTab, challengeType, setChallengeType } = useAuth();
  ...
  const { fetchAllChallenges, fetchAllPrivateChallenges } = useChallengeApi();
...
const filteredChallenges = selectedChallenges.filter((challenge) => {
  ...
  if (challenges.length === 0 && privateChallenges.length === 0) {
    return (
        ...
        <div className="bg-white rounded-3xl p-12 shadow-2xl border border-gray-100 max-w-lg w-full text-center">
          <div className="flex flex-col items-center space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">Check back soon for new opportunities! or create new challenge</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-6">
              Join the ultimate challenge hub! Create, participate, and conquer challenges with friends and the community.
            </p>
            </div>
         </div>
      </div>
